...
func (p *WebVulnPlugin) Fingers() []*base.Finger {
    ...
    fingers = append(fingers, &base.Finger{
        ...
        Channel:     "web-generic",
        Binding:     &base.VulnBinding{ID: "web-vuln-plugin/web-vuln-plugin/default", Plugin: "web-vuln-plugin/web-vuln-plugin", Category: "web-vuln-plugin"},
    })
    return fingers
}
...
// Init 插件初始化
func (p *WebVulnPlugin) Init(ctx context.Context, pci base.PluginConfigInterface, bb *base.BifrostBase) error {
    logger.Info("WebVulnPlugin init")
    return p.PluginMixinInitConfig.Init(ctx, pci)
}

// execAction 执行漏洞检测
func (p *WebVulnPlugin) execAction(ctx context.Context, b *base.Bifrost) error {
