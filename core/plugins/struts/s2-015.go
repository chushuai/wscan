...
func (*S015) Finger() *base.Finger {
	return &base.Finger{
		CheckAction: func(ctx context.Context, ab *base.Apollo) error {
			...
			logger.Debugf("Start detection S2-015, %s", flow.Request.URL())
		...
		Channel: "web-path",
		Binding: &model.VulnBinding{ID: "struts/s2-015/default", Plugin: "struts/s2-015", Category: "struts/s2-015", Severity: model.SeverityCritical},
	}
}
