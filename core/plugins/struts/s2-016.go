...
func (*S016) Finger() *base.Finger {
	return &base.Finger{
		CheckAction: func(ctx context.Context, ab *base.Apollo) error {
			...
			logger.Debugf("Start detection S2-016, %s", flow.Request.URL())
		...
		Channel: "web-path",
		Binding: &model.VulnBinding{ID: "struts/s2-016/default", Plugin: "struts/s2-016", Category: "struts/s2-016", Severity: model.SeverityCritical},
	}
}
