...
func (*S052) Finger() *base.Finger {
	return &base.Finger{
		CheckAction: func(ctx context.Context, ab *base.Apollo) error {
			...
			logger.Debugf("Start detection S2-052, %s", flow.Request.URL())
		...
		Binding: &model.VulnBinding{ID: "struts/s2-052/default", Plugin: "struts/s2-052", Category: "struts/s2-052", Severity: model.SeverityCritical},
	}
}
